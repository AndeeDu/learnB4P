...
``` r
install.packages(c("tidyverse", "brms", "tidybayes", "extraDistr", "HDInterval"))
```
...
All the materials of the workshop (data, code, slides) are in the workshop [repository](https://github.com/stefanocoretta/learnB4P) on GitHub.
